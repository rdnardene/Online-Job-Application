...
<head>
<meta charset="utf-8">
<title>Online Job Search Web App / <?php echo $title;?></title>
        ...
        <div class="navbar navbar-default navbar-static-top" > 
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo web_root; ?>index.php">Online Job Search Web Application<!-- <img src="<?php echo web_root; ?>plugins/home-plugins/img/logo.png" alt="logo"/> --></a>
                </div>
    ...
    <div class="row">
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          ...
          Brgy. Bonifacio, Near Airport<br>
           Pin-21542 Surigao City</address>
          <p>
            <i class="icon-phone"></i> (123) 456-789 - 1255-12584 <br>
            <i class="icon-envelope-alt"></i> airahpalima99@gmail.com
          </p>
        </div>
      </div>
      <div class="col-md-4 col-sm-4">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <div class="copyright">
            <p>
              <span>&copy; Airah Palima 2021 All rights reserved.  
            </p>
          </div>
        </div>
        <div class="col-lg-6">
